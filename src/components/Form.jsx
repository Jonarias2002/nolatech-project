        ...
        <div className=" bg-cover bg-center h-screen" style={{ backgroundImage: `url(${join})` }}>
            <div className='grid justify-end text-white pr-20 gap-5'>
                ...
                <div className=''>
                    ...
                    <input className='rounded mx-2 px-10 py-2' type="text" placeholder="Username"/>
                </div>
                <div className=''>
                    <input  className='rounded mx-2 px-10 py-2 text-black' type="text" placeholder="Phone" />
                    <input  className='rounded mx-2 px-10 py-2' type="text"  placeholder="Email" />
                </div>
                <div className=''>
                    <input className='rounded mx-1 py-2 px-5 w-full' type="text" placeholder="Departamen" />
